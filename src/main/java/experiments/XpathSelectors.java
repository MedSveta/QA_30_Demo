...
public class XpathSelectors {
    ...
    public void selectorsRadioButtonPage() {
        ...
        hideBanner();
        hideFooter();
        WebElement radioButtonYes1 = driver.findElement(By
                .cssSelector("*[for='yesRadio']"));
        WebElement radioButtonYes = driver.findElement(By
                .xpath("//label[@for='yesRadio']"));
        radioButtonYes.click();
        pause(4000);
        WebElement radioButtonImp = driver.findElement
                (By.xpath("//*[@for='impressiveRadio']"));
...
//        WebElement labelFullName = driver.findElement(By
...
//        labelFullName.sendKeys("Monkey");
        ...
        WebElement textareaCurAddress = driver
                .findElement(By.xpath("//textarea[@id='currentAddress']"));
        ...
        WebElement outputForm = driver.findElement(By
                .xpath("//div[@id='output']"));
